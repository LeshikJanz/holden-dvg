...
const ProductItemComponent = ({ product, snippetEnabled }) => !isEmpty(product) && (
  <div styleName="block">
    <div styleName="component">
      <div styleName="productHead">
        <div styleName="productHead-image">
          {snippetEnabled ? (
            <a href={`http://www.dvg.com.au/cars/products/${product.Make}-${product.Model}-${product.ComplianceYear}-for-sale-perth-${product.StockNumber}`}>
              <ProductGalleryComponent product={product} />
            </a>
          ) : (
            <Link to={{ pathname: `/products/${product.Make}-${product.Model}-${product.ComplianceYear}-for-sale-perth-${product.StockNumber}` }}>
              <ProductGalleryComponent product={product} />
            </Link>
          )}
      ...
      <div styleName="productPrice">
        {isNumber(product._ft.Price) ?
          (<div>
            <div styleName="price">
              <div styleName="number">
                ${roundProductPrice(product._ft.Price)}
              </div>
